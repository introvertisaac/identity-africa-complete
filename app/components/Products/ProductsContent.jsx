...
const ProductsSolutions = () => {
  ...
  const customerVerificationCards = [
    ...
    { title: "Transactional Data", content: "Verify and authenticate customer bank accounts  and phone number datafor effective risk control and secure digital banking", icon: <FaChartLine /> },
